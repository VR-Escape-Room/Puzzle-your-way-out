Shader "Unlit/WireframeQuad"
{
    Properties
    {
        ...
        _WireframeFrontColour("Wireframe front color", color) = (1.0, 1.0, 1.0, 1.0)
        _WireframeEdgeColor("Wireframe edge color", color) = (1.0, 1.0, 1.0, 1.0)
        ...
        Pass
        {
                ...
                fixed4 frag(g2f i) : SV_Target
                {
                    ...
                    if (alpha > 0.5)
                    {
                        return _WireframeEdgeColor;
                    }
                    return _WireframeFrontColour;
